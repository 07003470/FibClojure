(comment define function- fib with 1 argument- n)
(defn fib [n]
(comment create anonymous function- fn with 4 arguments- a,b,c, seq)
  ((fn [a b c seq]
  (comment anonymous function pass to conditional statement before recursion look through line 8)
    (cond (= 1 n) [1]
      (= c n) seq
      :else (recur b (+ a b) (inc c) (conj seq (+ a b)))))
  1 1 2 [1 1])) 
  (comment line 9 numbers passed as arguments through anonymous function ie a-[1] b-[1] c-[2] and vector sequence [1 1]line 4)
(defn -main [& args]
